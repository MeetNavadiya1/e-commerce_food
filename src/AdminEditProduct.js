...
export default function AdminEditProduct() {
  ...
  let updateProduct = function (event) {
    ...
    console.log(selectedCategory, name, price, size, weight, stock, isLive, comments, photo);
    //api call
    let apiAddress = getBase() + "update_product.php";
    let form = new FormData();
    // name,photo,price,stock,detail,productid,categoryid (required)
                    ...
                    <form onSubmit={updateProduct} method="post" encType="multipart/form-data">
                      <div className="row">
                        <div className="col-lg-3">
                          ...
                          <img src={"https://www.theeasylearnacademy.com/shop/images/product/" + OldPhoto} className="img-fluid" />
                        </div>
                        <div className="col-lg-9">
                          <div className="row">
                            ...
                            <div className="col-lg-4 pt-2">
                              <div className="form-floating mb-3">
                                <input type="number" className="form-control" id="price" placeholder="price" value={price}
                          ...
                          <div className="row">
                            <div className="col-lg-4">
                              <div className="form-floating mb-3">
                                <input type="number" className="form-control" id="stock" placeholder="available quantity for sell" value={stock}
                            ...
                            <div className="col-lg-4">
                              <div className="form-floating mb-3">
                                <input type="text" className="form-control" id="size" placeholder="Product Size" value={size}
                            ...
                            <div className="col-lg-4">
                              <div className="form-floating mb-3">
                                <input type="number" className="form-control" id="weight" placeholder="Weight" value={weight}
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-4">
                              <div className="form-floating">
                                <textarea className="form-control" placeholder="Leave a comment here" id="floatingTextarea" style={{ "height": "100px" }} value={comments} onChange={(event) => setComments(event.target.value)}>
                                </textarea>
                          ...
                          <div className="row">
                            <div className="col-12 text-end">
                              ...
                              <button onClick={resetForm} type="reset" className="btn btn-secondary">Clear all</button>
                            </div>
                          </div>
                        </div>
                      </div>
