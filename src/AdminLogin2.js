...
export default function AdminLogin2() {
  ...
  let Login = function (event) {
    let apiAddress = "http://127.0.0.1:5000/login";
      ...
      <div className="authentication-inner">
        ...
        <div className="card">
          <div className="card-body">
            ...
            {/* /Logo */}
            <h4 className="mb-2 text-center">Admin Login (nodejs)</h4>
            <form  id="formAuthentication" className="mb-3" method="POST"
              onSubmit={Login}>
              <div className="mb-3">
                <label htmlFor="email" className="form-label">Email</label>
                <input type="email" className="form-control" id="email" name="email" placeholder="Enter your email" autofocus required
              ...
              <div className="mb-3 form-password-toggle">
                ...
                <div className="input-group input-group-merge">
                  <input type="password" id="password" className="form-control" name="password" placeholder="············" aria-describedby="password" required value={password} onChange={(event) => setPassword(event.target.value)} />
